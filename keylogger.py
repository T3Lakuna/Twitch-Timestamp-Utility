...
print(shell.SHGetFolderPath(0, shellcon.CSIDL_PROFILE, None, 0) + "\\Downloads\\")
client_id = '2be6yrftbjgdrs0hov5lhz3uszezzv'
redirect_uri = 'http://localhost:3000/'
webbrowser.open_new('https://id.twitch.tv/oauth2/authorize?client_id=' + client_id + '&redirect_uri=' + redirect_uri + '&response_type=token&scope=')
